            ...
            <div class="row d-flex justify-content-center text-center">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="index.php?action=article&id=<?= $post['id']; ?>" target = "_blank"><button type="button" class="btn btn-outline-primary btn-sm" title="Voir l'article"><i class="fas fa-eye"></i></button></a>
                        <a href="index.php?action=addModificationArticle&id=<?= $post['id']; ?>"><button type="button" class="btn btn-outline-success btn-sm" title="Modifier l'article"><i class="fas fa-edit"></i></button></a>
                        <a href="index.php?action=deleteArticle&id=<?= $post['id']; ?>" onClick='return confirmation();'><button type="button" class="btn btn-outline-danger btn-sm" title="Supprimer l'article"><i class="fas fa-trash"></i></button></a>
                        </td>
                    </tr>
...
<script type="text/javascript" src="src/Assets/ressources/js/deleteArticleConfirmation.js"></script>
